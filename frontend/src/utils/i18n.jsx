...
const translations = {
  en: {
    ...
    // Grades & Topics
    grade6to11: 'Grade 6-11',
    gradeProgress: 'Grade Progress',
    topic: 'Topic',
    topics: 'Topics',
    topicManagement: 'Topic Management',
    currentGrade: 'Current Grade',
    lockedGrade: 'Complete current grade to unlock',
    globalFinal: 'Global Final',
    isFinal: 'Final Tasks',
    isGlobalFinal: 'Global Final',
    ...
    completed: 'Completed',
    noTopic: 'No Topic',
    noTopicsYet: 'No topics yet. Create the first one.',
    noLessonsForGrade: 'No lessons for this grade yet.',
  ...
  ru: {
    ...
    // Grades & Topics
    grade6to11: 'Класс 6-11',
    gradeProgress: 'Прогресс классов',
    topic: 'Тема',
    topics: 'Темы',
    topicManagement: 'Управление темами',
    currentGrade: 'Текущий класс',
    lockedGrade: 'Завершите текущий класс',
    globalFinal: 'Общий финал',
    isFinal: 'Итоговые задания',
    isGlobalFinal: 'Глобальный финал',
    ...
    completed: 'Завершено',
    noTopic: 'Без темы',
    noTopicsYet: 'Тем пока нет. Создайте первую.',
    noLessonsForGrade: 'Уроков для этого класса пока нет.',
